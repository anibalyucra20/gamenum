        ...
        <div id="pantalla-juego" class="hidden container mx-auto max-w-2xl py-10 px-4">
            ...
            <div class="bg-white p-8 rounded-xl shadow-2xl border-t-4 border-blue-500">
                ...
                <div id="seccion-ayuda" class="hidden mt-6 p-5 bg-red-50 border-l-4 border-red-500 rounded-lg">
                    ...
                    <button onclick="mostrarVideo()" class="w-full bg-red-600 text-white px-4 py-3 rounded-lg text-sm flex items-center justify-center gap-2 hover:bg-red-700 transition font-bold shadow-md">
                        Ver Tutorial en YouTube 🎥
                    </button>
                    <div id="contenedor-imagen-ayuda" class="hidden mt-4 bg-white p-2 rounded border shadow-inner">
                        <p class="text-xs text-gray-400 mb-1 font-bold">RECURSO VISUAL:</p>
                        <img id="formula-imagen" src="" alt="Fórmula de ayuda" class="max-w-full h-auto mx-auto rounded">
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
            ...
            function renderizarInterfazRespuesta() {
                ...
                if (preguntaActualData.formato === 'relacionar') {
                    ...
                    if (preguntaActualData.opcion_d) opciones.push(preguntaActualData.opcion_d);
                    if (preguntaActualData.opcion_e) opciones.push(preguntaActualData.opcion_e);
                    ...
                    opciones.forEach(opt => {
                        const btn = document.createElement('button');
                        btn.innerText = opt;
                        btn.className = "p-4 bg-gray-50 border-2 border-gray-200 rounded-xl hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all duration-200 font-bold text-lg shadow-sm transform hover:-translate-y-1";
                    ...
                    setTimeout(() => {
                        ...
                        if (input) {
                            input.focus();
                            btn.onclick = () => validarRespuesta(input.value);
                            input.onkeypress = (e) => {
